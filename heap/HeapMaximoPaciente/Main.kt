...
var contadores = arrayOf(10000000000000L, 10000000000000L, 10000000000000L)

fun zeroEsquerda(valor: String): String {
...
fun novaPrioridade(prioridade: Prioridade) : Long {
    ...
    val novaPrioridade = posicao.toString() + zeroEsquerda(contadorString)
